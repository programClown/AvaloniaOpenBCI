...
namespace NaviAvalonia.Extensions;
...
{
    private static readonly Dictionary<Type, List<Type>> PrimitiveTypeConversions =
        new()
        {
            {
                typeof(decimal),
            ...
            {
                typeof(ulong),
                new List<Type> { typeof(byte), typeof(ushort), typeof(uint), typeof(char) }
            },
            {
                typeof(long),
                new List<Type>
            ...
            {
                typeof(uint),
                new List<Type> { typeof(byte), typeof(ushort), typeof(char) }
            },
            {
                typeof(int),
                new List<Type> { typeof(sbyte), typeof(byte), typeof(short), typeof(ushort), typeof(char) }
            },
            {
                typeof(ushort),
                new List<Type> { typeof(byte), typeof(char) }
            },
            {
                typeof(short),
    ...
    private static readonly Dictionary<Type, string> TypeKeywords =
        new()
        {
            { typeof(bool), "bool" },
            { typeof(byte), "byte" },
    ...
    public static bool IsNumber([NotNullWhen(true)] this object? value)
    {
