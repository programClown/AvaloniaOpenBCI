...
{
    public static string DefaultFontFamily = "fonts:AlibabaPuHuiTi#Alibaba PuHuiTi 3.0";
    public static Uri Key { get; } = new("fonts:AlibabaPuHuiTi", UriKind.Absolute);
    public static Uri Source { get; } = new("avares://AvaloniaOpenBCI/Assets/Fonts/AliBaba", UriKind.Absolute);
}
...
{
    public static string DefaultFontFamily = "fonts:HarmonyOS_Sans_SC#HarmonyOS Sans SC";
    public static Uri Key { get; } = new("fonts:HarmonyOS_Sans_SC", UriKind.Absolute);
    public static Uri Source { get; } = new("avares://AvaloniaOpenBCI/Assets/Fonts/HarmonyOS Sans", UriKind.Absolute);
}
    ...
    public static AppBuilder UseAliBabaFontFamily([DisallowNull] this AppBuilder builder)
    {
        builder.With(
            new FontManagerOptions
            {
                ...
                FontFallbacks = new[]
                {
                    new FontFallback { FontFamily = new FontFamily(AlibabaFontSettings.DefaultFontFamily) }
                }
            }
        );
    ...
    public static AppBuilder UseHarmonyOSFontFamily([DisallowNull] this AppBuilder builder)
    {
        builder.With(
            new FontManagerOptions
            {
                ...
                FontFallbacks = new[]
                {
                    new FontFallback { FontFamily = new FontFamily(HarmonyOSFontSettings.DefaultFontFamily) }
                }
            }
        );
        return builder.ConfigureFonts(
